...
var Bill, File, async, baseKonnector, buildNotification, cheerio, cozydb, customLinkBankOperation, fileOptions, filterExisting, fs, getPdf, linkBankOperation, localization, log, logIn, moment, parsePage, request, saveDataAndFile;
...
module.exports = baseKonnector.createNew({
  ...
  models: [Bill],
  fetchOperations: [logIn, parsePage, filterExisting(log, Bill), saveDataAndFile(log, Bill, fileOptions, ['health', 'bill']), customLinkBankOperation, buildNotification]
});
