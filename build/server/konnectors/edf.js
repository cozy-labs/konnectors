...
var Bill, Client, ConsumptionStatement, Contract, File, Folder, Home, K, PaymentTerms, _extend, async, buildNotifContent, builder, cozydb, createNewFile, displayData, edfRequestPost, fetchEdeliaElecIndexes, fetchEdeliaGasIndexes, fetchEdeliaMonthlyElecConsumptions, fetchEdeliaMonthlyGasConsumptions, fetchEdeliaProfile, fetchEdeliaSimilarHomeYearlyElecComparisions, fetchEdeliaSimilarHomeYearlyGasComparisions, fetchEdeliaToken, fetchListerContratClientParticulier, fetchPDF, fetchRecupereDocumentContractuelListx, fetchVisualiserAccordCommercial, fetchVisualiserCalendrierPaiement, fetchVisualiserHistoConso, fetchVisualiserPartenaire, getEDFToken, getEdelia, getF, localization, logger, moment, parser, prepareEntries, request, saveMissingBills, translate, updateOrCreate, xml2js,
  slice = [].slice;
