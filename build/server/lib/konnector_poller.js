...
KonnectorPoller = (function() {
  ...
  KonnectorPoller.prototype.prepareNextCheck = function() {
    var konnector, nextUpdate, slug, _i, _len, _ref, _ref1, _results;
    _ref = Object.keys(this.nextUpdates);
    _results = [];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      slug = _ref[_i];
      _ref1 = this.nextUpdates[slug], nextUpdate = _ref1[0], konnector = _ref1[1];
      _results.push(this.createTimeout(konnector, nextUpdate));
    }
    return _results;
  };
