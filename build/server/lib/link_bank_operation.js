...
BankOperationLinker = (function() {
  function BankOperationLinker(options) {
    this.linkOperation = __bind(this.linkOperation, this);
    this.linkOperationIfExist = __bind(this.linkOperationIfExist, this);
  ...
  BankOperationLinker.prototype.linkRightOperation = function(operations, entry, callback) {
    var amount, operation, operationAmount, operationToLink, _i, _len;
