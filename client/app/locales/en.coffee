module.exports =
    ...
    'konnector description free': "Download all your internet invoices from Free. This konnector requires the Files application to store the invoice PDF files."
    'konnector description free mobile': "Download all your phone invoices from Free Mobile. This konnector requires the Files application to store the invoice PDF files."
    'konnector description bouygues': "Download all your phone invoices from Bouygues Telecom. This konnector requires the Files application to store the invoice PDF files."
    'konnector description bouygues box': "Download all your internet invoices from Bouygues Telecom. This konnector requires the Files application to store the invoice PDF files."
    'konnector description sfr_box': "Download all your internet invoices from SFR or Red. This konnector requires the Files application to store the invoice PDF files."
    'konnector description sfr_mobile': "Download all your mobile invoices from SFR or Red. This konnector requires the Files application to store the invoice PDF files."
    'konnector description github': "Download all your Github invoices. This konnector requires the Files application to store the invoice PDF files."
    ...
    """
    'konnector description digital ocean': "Download all your Digital Ocean invoices. This konnector requires the Files application to store the invoice PDF files."
    'konnector description sosh': "Download all your Sosh invoices. This konnector requires the Files application to store the invoice PDF files."
    'konnector description electrabel': "Download all you Electrabel invoices. This konnector requires the Files application to store the invoice PDF files."
    'konnector description orange': "Download all your Orange invoices. This konnector requires the Files application to store the invoice PDF files."
    'konnector description nest': "Save current temperature measured by your Nest thermostat."
    'konnector description numericable': "Download all your Numéricable invoices. This konnector requires the Files application to store the invoice PDF files."
    'konnector description virginmobile': "Download all your Virgin Mobile  invoices. This konnector requires the Files application to store the invoice PDF files."
    'konnector description online_net': "Download all your Online.net invoices. This konnector requires the Files application to store the invoice PDF files."
    'konnector description ovh_eu': """
    Download all your OVH Europe invoices. This konnector requires the Files application to store the invoice PDF files.<br/>
    ...
    Download all your OVH North-America invoices. This konnector requires the Files application to store the invoice PDF files.<br/>
    ...
    Download all your RunAbove invoices. This konnector requires the Files application to store the invoice PDF files.<br/>
    ...
    Download all your Kimsufi Europe invoices. This konnector requires the Files application to store the invoice PDF files.<br/>
    ...
    Download all your Kimsufi North-America invoices. This konnector requires the Files application to store the invoice PDF files.<br/>
    ...
    Download all your SoYouStart Europe invoices. This konnector requires the Files application to store the invoice PDF files.<br/>
    ...
    Download all your SoYouStart North-America invoices. This konnector requires the Files application to store the invoice PDF files.<br/>
    ...
    'konnector description sncf': "Import your SNCF invoices and events in your Cozy."
    ...
    'konnector description vente_privee' : 'Downloads all your invoices from the vente-privee.com website.'
    ...
    'notification captain_train': "%{smart_count} new invoice imported |||| %{smart_count} new invoices imported"
