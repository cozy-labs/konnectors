...
diacritics =
    ...
    # CANT FIND APPROXIMATION FOR 'LATIN CAPITAL LETTER CON' (Ꝯ)
    # CANT FIND APPROXIMATION FOR 'LATIN CAPITAL LETTER CUATRILLO' (Ꜭ)
    # CANT FIND APPROXIMATION FOR 'LATIN CAPITAL LETTER CUATRILLO WITH COMMA'(Ꜯ)
    ...
    # CANNOT FIND APPROXIMATION
    # FOR 'LATIN CAPITAL LETTER SMALL Q WITH HOOK TAIL' (Ɋ)
    ...
    # CANNOT FIND APPROXIMATION
    # FOR 'LATIN CAPITAL LETTER THORN WITH STROKE THROUGH DESCENDER' (Ꝧ)
    ...
    # CANNOT FIND APPROXIMATION
    # FOR 'LATIN LETTER INVERTED GLOTTAL STOP WITH STROKE' (ƾ)
    # CANNOT FIND APPROXIMATION FOR 'LATIN LETTER LATERAL CLICK' (ǁ)
    # CANNOT FIND APPROXIMATION
    # FOR 'LATIN LETTER PHARYNGEAL VOICED FRICATIVE' (ʕ)
    ...
    # CANNOT FIND APPROXIMATION
    # FOR 'LATIN LETTER REVERSED GLOTTAL STOP WITH STROKE' (ʢ)
    ...
    # CANNOT FIND APPROXIMATION
    # FOR 'LATIN SMALL CAPITAL LETTER I WITH STROKE' (ᵻ)
    # CANNOT FIND APPROXIMATION
    # FOR 'LATIN SMALL CAPITAL LETTER U WITH STROKE' (ᵾ)
    ...
    # CANNOT FIND APPROXIMATION
    # FOR 'LATIN SMALL LETTER ALPHA WITH RETROFLEX HOOK' (ᶐ)
    ...
    # CANNOT FIND APPROXIMATION
    # FOR 'LATIN SMALL LETTER DZ DIGRAPH WITH CURL' (ʥ)
    ...
    # CANNOT FIND APPROXIMATION
    # FOR 'LATIN SMALL LETTER ESH WITH PALATAL HOOK' (ᶋ)
    # CANNOT FIND APPROXIMATION
    # FOR 'LATIN SMALL LETTER ESH WITH RETROFLEX HOOK' (ᶘ)
    ...
    # CANNOT FIND APPROXIMATION
    # FOR 'LATIN SMALL LETTER EZH WITH RETROFLEX HOOK' (ᶚ)
    ...
    # CANNOT FIND APPROXIMATION
    # FOR 'LATIN SMALL LETTER N PRECEDED BY APOSTROPHE' (ŉ)
    ...
    # CANNOT FIND APPROXIMATION
    # FOR 'LATIN SMALL LETTER REVERSED OPEN E WITH HOOK' (ɝ)
    # CANNOT FIND APPROXIMATION
    # FOR 'LATIN SMALL LETTER REVERSED OPEN E WITH RETROFLEX HOOK' (ᶔ)
    ...
    # CANNOT FIND APPROXIMATION
    # FOR 'LATIN SMALL LETTER SCHWA WITH RETROFLEX HOOK' (ᶕ)
    'ɡ': 'g', # LATIN SMALL LETTER SCRIPT G
    'ß': 'ss', # LATIN SMALL LETTER SHARP S
    # CANNOT FIND APPROXIMATION
    # FOR 'LATIN SMALL LETTER SIDEWAYS DIAERESIZED U' (ᴞ)
    ...
    # CANNOT FIND APPROXIMATION
    # FOR 'LATIN SMALL LETTER TC DIGRAPH WITH CURL' (ʨ)
    ...
    # CANNOT FIND APPROXIMATION
    # FOR 'LATIN SMALL LETTER THORN WITH STROKE THROUGH DESCENDER' (ꝧ)
...
asciize = (str) ->
    return str.replace /[^A-Za-z0-9\[\] ]/g, (a) -> return diacritics[a] or a
